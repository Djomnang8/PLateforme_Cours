...
public class EmployeeController {
    ...
    @PostMapping public AppUser create(@RequestBody AppUser u){ u.setId(null); u.setPassword(encoder.encode(u.getPassword())); return repository.save(u);} 
    @PutMapping("/{id}") public AppUser update(@PathVariable Long id,@RequestBody AppUser u){ u.setId(id); u.setPassword(encoder.encode(u.getPassword())); return repository.save(u);} 
